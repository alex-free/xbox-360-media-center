# Xbox 360 Media Center (X360MC) - YouTube Download Conversion/Local Media Conversion For The Xbox 360 Native Video Player
...
### Version 1.0.1 (5/8/2026)

Changes:

* Fixes permissions for yt-dlp.

* Revert format audio format 240 to format 140 for audio to fix format not available with just denvo in modern bundled yt-dlp.

* Converted ffmpeg-static to ffmpeg-pled with proprietary codec support.

* Removed ``-yl` and `-yh` options. Just use `-y` to get YouTube videos.
...
* [xbox-360-media-center-v1.0.1.deb](https://github.com/alex-free/xbox-360-media-center/releases/download/v1.0.1/xbox-360-media-center-v1.0.1.deb) _Deb package file for x86\_64 Linux (64 bit)_

* [xbox-360-media-center-v1.0.1-1.x86\_64.rpm](https://github.com/alex-free/xbox-360-media-center/releases/download/v1.0.1/xbox-360-media-center-v1.0.1-1.x86_64.rpm) _RPM package file for x86\_64 Linux (64 bit)_
...
`x360mc -y <YouTube URL>     Download YouTube video as an Xbox 360 compatible H.264 MP4 at the highest resolution availble up to 1080p (must have double quotes around URL).`
...
* [FFmpeg](https://github.com/BtbN/FFmpeg-Builds/releases) (LGPLv3 license). The portable Linux build uses FFMpeg v7.1.2 from Fedora, made portable with my [PLED](https://github.com/alex-free/pled) tool. The Linux package file releases use the FFmpeg from your Linux distro (which will automatically be installed if they are not detected as such).
